...
const marketingDigital: BusinessType[] = [
  t("afiliado",      "Afiliados (Shopee / ML / AliExpress / TikTok)", "Afiliados e Marketplaces", "Assistente de Afiliados", "afiliado", "Entusiasmado e Persuasivo", AFF, "Use a ferramenta de busca imediatamente ao receber qualquer solicitação de produto — não peça mais informações antes de buscar. Sempre apresente pelo menos 3 opções. Destaque promoções, frete grátis e boa avaliação quando disponíveis.", ["Sempre apresentar pelo menos 3 opções de produto", "Nunca inventar preço, avaliação ou link — usar apenas o que a busca retornar", "Destacar quando produto está em promoção"]),
