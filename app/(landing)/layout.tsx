          ...
          <div className="flex items-center gap-6">
            {!user ? (
              ...
              <Button asChild className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-6 shadow-lg shadow-indigo-500/20">
                <Link href="/app">Ir para Painel <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><Link href="/funcionalidades" className="hover:text-indigo-400 transition-colors">Funcionalidades</Link></li>
                <li><Link href="/precos" className="hover:text-indigo-400 transition-colors">Preços</Link></li>
                <li><Link href="/setores" className="hover:text-indigo-400 transition-colors">Setores</Link></li>
                <li><Link href="/integracoes" className="hover:text-indigo-400 transition-colors">Integrações</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li><Link href="/api-docs" className="hover:text-indigo-400 transition-colors">Documentação da API</Link></li>
                <li><Link href="/ajuda" className="hover:text-indigo-400 transition-colors">Central de Ajuda</Link></li>
                <li><Link href="/cases" className="hover:text-indigo-400 transition-colors">Casos de Sucesso</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><Link href="/sobre" className="hover:text-indigo-400 transition-colors">Sobre Nós</Link></li>
                <li><Link href="/contato" className="hover:text-indigo-400 transition-colors">Contato</Link></li>
                <li><Link href="/termos" className="hover:text-indigo-400 transition-colors">Termos de Uso</Link></li>
                <li><Link href="/privacidade" className="hover:text-indigo-400 transition-colors">Política de Privacidade</Link></li>
              </ul>
            </div>
          </div>
